...
namespace FlyEngine
{
	namespace Utils
	{
		...
		public:
			...
			static void ConsoleMessage(const char* initialMsg, glm::vec3 vector3, short beforeSpacesCount = 0, short afterSpacesCount = 1, short beforeEndlCount = 0, short afterEndlCount = 1);
